...
#SBATCH --output=const_full_front_logs/%A-%a.out
#SBATCH --error=const_full_front_logs/%A-%a.err
...
python const_full_front_split_halo_mcmc_script.py $SLURM_ARRAY_TASK_ID
