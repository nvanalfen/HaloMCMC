...
if __name__ == "__main__":
    ...
    omega_df = pd.read_csv("static_halos_galaxy_sat_shape_cen_pos_omegas_a=0.797_gamma=0_seed=132358712.csv", index_col=False)
    ...
    try:
        start = time.time()
        f_name = os.path.join("const_front_results","MCMC_"+job+".h5")
