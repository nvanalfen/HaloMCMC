...
if __name__ == "__main__":
    ...
    omega_df = pd.read_csv("static_halos_all_galaxy_omega_a=0.7995_gamma=-0.0361_seed=132358712.csv", index_col=False)
    ...
    try:
        start = time.time()
        f_name = os.path.join("full_front_results","MCMC_"+job+".h5")
