...
#SBATCH --output=isotropic_full_total_logs/%A-%a.out
#SBATCH --error=isotropic_full_total_logs/%A-%a.err
...
python isotropic_split_halo_mcmc_script.py $SLURM_ARRAY_TASK_ID variables/isotropic_full_total.txt
