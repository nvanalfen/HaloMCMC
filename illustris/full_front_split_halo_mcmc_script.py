...
if __name__ == "__main__":
    ...
    #omega_df = pd.read_csv("static_halos_galaxy_sat_shape_cen_pos_omegas_radial_AS_seed=132358712.csv", index_col=False)
    ...
    omega_mean = np.load("TNG300-1_99-sample_3_ed.npy")
    ...
    rbins = np.load("rbins.npy")
    rbin_centers = np.load("rbin_centers.npy")
    ...
    cov = np.load("TNG300-1_99-sample_3_ed_cov.npy")
    cov = cov[:split,:split]
